...
public:
	...
	//! Particles Distorting
	void HandleParticlesDistorting();
...
#endif
	std::function<std::vector<char>(const char *)> loadResourceProvider;
    std::function<void( void*, int, void*, void*, void*, void* )> animateMeshGate;
