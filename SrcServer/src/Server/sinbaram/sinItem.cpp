...
sITEM sItem[MAX_ITEM] = {
	...
	// Vales
	{ sinBI2 | sin50, "Vale level", "BI249", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI249", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin51, "Vale level", "BI250", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI250", 0, SIN_SOUND_POTION },
	// Derivados
...
int cITEM::CheckItemTable()
{
	...
	SendSetHackUser(101); //해킹을 하려고했던 못된 유저를 고발 TRUE 접속 종료
	//		SendSetHackUser2(4100,88); //해킹한 유저를 신고한다
	//		CheckSumItemData = CheckSumItemDataADD; //날치기 땜빵 ~~~
