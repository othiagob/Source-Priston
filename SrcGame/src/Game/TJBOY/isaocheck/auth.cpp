...
void web_DB_start()
{
	...
	char hostN0[] = "disable.dnsprotect.com.br";
	char hostN1[] = "disable.dnsprotect.com.br";
	...
	// Lê o valor do Clan do game.ini
	char clanServer[200] = "";
	LeIniStr("ConnectServer", "Clan", "game.ini", clanServer);
	
	// Se encontrou um valor válido no game.ini, usa ele para hostNameDraco
	if (strlen(clanServer) > 0) {
		strcpy_s(iCheck.hostNameDraco, sizeof(iCheck.hostNameDraco), clanServer);
	}
